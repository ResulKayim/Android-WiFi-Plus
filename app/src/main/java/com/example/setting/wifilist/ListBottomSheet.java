package com.example.setting.wifilist;
...
import com.example.setting.wifi.WifiSheetAdapter;
...
public class ListBottomSheet extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.button_list_wifi_sheet, container, false);
